...
11	Mini e-commerce
12	Gestor de notas Rich Text
13	Gerador de certificados PDF
14	API RESTful de tarefas (CRUD)
15	API GraphQL de produtos/posts
16	Sistema de agendamento
17	Upload de arquivos com autenticação
18	API de chatbot simples
19	Bot para Telegram
20	Bot para WhatsApp
...
27	Detecção de rosto em tempo real
28	Previsor de preços
29	Analisador de spam
30	CLI tool para automatização
31	Rede social temática
32	Plataforma de cursos online
33	Marketplace de freelancers
